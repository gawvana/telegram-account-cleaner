...
SECURITY_NOTICE = (
    "⚠️ ВНИМАНИЕ: Служба поддержки CLIN НИКОГДА не запрашивает ваши пароли, коды подтверждения "
    "или 2FA-пароли от Telegram! Никогда не отправляйте их в тикетах или чатах."
)
...
FAQ_ITEMS = [
    {
        ...
        "answer": "Да. Сессии Telegram шифруются локально алгоритмом Fernet (AES-128-CBC) с индивидуальной солью для каждого пользователя. Ваши ключи и пароли не передаются третьим лицам.",
    },
    {
        "id": "faq-2",
